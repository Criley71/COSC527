...
class CASimulator():
    ...
    def simulate(self):
        ...
        for experiment in range(self.num_experiments):
            ...
            f.write("Step,Entry Zeroed,Class,Lambda,Lambda_t,H,H_t,Lempel-Ziv Complexity,Zeta,Observations\n")
            ...
            for z in range(len(self.rule_table)):
                ...
                LZ = self.calculate_lz_complexity()
                f.write(str(z) + "," + entry_zeroed + ",," + str(lam) + "," + str(lam_T) + "," + str(H) + "," + str(H_T) + ","+str(LZ)+ ",,\n") 
